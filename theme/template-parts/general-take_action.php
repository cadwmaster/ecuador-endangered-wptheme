<?php
/**
 * The template part for displaying take action
 */
?>

<div>
	<div class="content-take_action"> 
		<div class="international">
			<div class="wrapper">
				<div class="title"><?php _e('take_action_international title', 'twentysixteen'); ?></div>
		...
		<div class="ecuador">
			<div class="wrapper">
				<div class="title"><?php _e('take_action_ecuador title', 'twentysixteen'); ?></div>
