	...
	class Newsletter_Widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			echo '<div class="content newsletter">';
				...
				echo '	<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="'.__('widget newsletter email placeholder', 'twentysixteen').'" required>';
				...
				echo '	<div class="clear"><input type="submit" value="'.__('widget newsletter button suscribe', 'twentysixteen').'" name="subscribe" id="mc-embedded-subscribe" class="button"></div>';
				echo '	</div>';
				echo '</form>';
				echo '</div>';
			echo '</div>';
